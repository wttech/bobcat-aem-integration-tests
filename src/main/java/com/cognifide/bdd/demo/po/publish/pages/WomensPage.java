...
@PageObject
public class WomensPage extends PublishPage {

  private static final String CONTENT_PATH = "/content/geometrixx-outdoors/en/women.html";

  private static final String TITLE = "Women's";
