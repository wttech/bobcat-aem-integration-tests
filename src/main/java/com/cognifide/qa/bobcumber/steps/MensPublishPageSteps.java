...
@ScenarioScoped
public class MensPublishPageSteps {

  @Inject
  private MensPage mensPage;

  @Then("^men page is displayed$")
  public void menPageIsDisplayed() {
    assertTrue(mensPage.isDisplayed());
  }

  @Given("^I have opened men page$")
  public void iHaveOpenedMenPage() {
    mensPage.open();
  }

  @When("^I click product link$")
  public void iClickProductLink() {
    mensPage.clickAshantiNomadLink();
  }
}
