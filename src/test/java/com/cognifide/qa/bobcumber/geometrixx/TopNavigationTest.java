 ...
 * #L%
 */
package com.cognifide.qa.bobcumber.geometrixx;
...
@CucumberOptions(
    ...
    plugin = {"pretty", "html:target/cucumber-html-report/top-navigation",
        "json:target/topNavigationTest.json"},
    tags = {"@topNavigation", "~@disabled"},
